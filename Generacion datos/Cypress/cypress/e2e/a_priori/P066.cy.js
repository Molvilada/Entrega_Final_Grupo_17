...
import jsonData from "./data/P066.json";

const tagSection = new TagSection();
const adminMenu = new AdminMenu();
const site = new Site();

describe("Editar Tag con la descripción vacia.", () => {
  it("Editar Tag con la descripción vacia.", () => {
    /* 
    -------------
      GIVEN
    -------------
    ...
    */
    ...
    cy.wait(2000);  
    // Actualiza el titulo
    tagSection.updateTagDescriptionEmpty() ;
    cy.wait(1000);
    tagSection.saveTag.click();
    /* 
    -------------
