...
describe("Editar biografía de usuario", () => {
    it('Editar la biografía de usuario con 201 caracteres', () => {
        ...
        cy.wait(1000);
        const testMockaroo = '/p114.json';
        staffSection.getDinamicBioMockaroo(testMockaroo).then((bioData) => {
            const bio = bioData.bio;
            staffSection.bioField.type(bio, {
                force: true
            });
            ...
            staffSection.bioField.clear();
            cy.wait(1000);
            staffSection.bioField.type('I am a ghost', {
                force: true
            });
